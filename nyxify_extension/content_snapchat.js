(function () {
  ...
  function sendResult(forceUnknown) {
    ...
    chrome.runtime.sendMessage({
      type: "NYXIFY_SCRAPE_SNAPCHAT_RESULT",
      payload: {
        username: username,
  ...
  try {
    if (typeof chrome !== "undefined" && chrome && chrome.storage && chrome.storage.local) {
      chrome.storage.local.get("nyxifyUsernameScrapeConfig", function (data) {
        var config = data && data.nyxifyUsernameScrapeConfig ? data.nyxifyUsernameScrapeConfig : {};
